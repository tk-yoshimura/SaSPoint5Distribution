...
namespace SaSPoint5PadeCoefGeneration {
    internal class QuantileNZ {
        static void Main_() {
            ...
            using (BinaryReader sr = new(File.OpenRead("../../../../results_disused/quantile_precision230_scaled_2.bin"))) {
            ...
            using (StreamWriter sw = new("../../../../results_disused/pade_quantile_precision150_scaled_nz.csv")) {
